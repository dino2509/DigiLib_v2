...
<div class="page-header">
    ...
    <div style="display:flex; gap:14px; align-items:center;">
        ...
        <!-- SEARCH FORM -->
        <form method="get"
              action="${pageContext.request.contextPath}/librarian/books"
              class="search-bar">
        ...
        <!-- ADD BOOK -->
        <a href="${pageContext.request.contextPath}/librarian/books?action=add"
           class="btn-orange">
            + Add New Book
        </a>
    </div>
    ...
    <tbody>
        <c:forEach var="b" items="${books}">
            <tr class="clickable-row"
                onclick="window.location = '${pageContext.request.contextPath}/librarian/books/detail?id=${b.bookId}'">
                ...
                <td onclick="event.stopPropagation();">
                    <a class="btn-action btn-delete"
                       title="Xóa"
                       href="${pageContext.request.contextPath}/librarian/books?action=delete&id=${b.bookId}"
