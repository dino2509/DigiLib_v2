...
<div class="container">
    ...
    <div class="search-card">
        ...
        <form method="get"
              ...
              action="${pageContext.request.contextPath}/reader/advanced-search">
            ...
            <div class="row">
                ...
                <select name="logic1">
                    ...
                    <option value="AND"
                            <c:if test="${logic1 == 'AND'}">selected</c:if>>
                                AND
                            </option>

                            <option value="OR"
                            <c:if test="${logic1 == 'OR'}">selected</c:if>>
                                OR
                            </option>
                ...
                <select name="logic2">
                    <option value="AND" <c:if test="${logic2 == 'AND'}">selected</c:if>>AND</option>
                    <option value="OR" <c:if test="${logic2 == 'OR'}">selected</c:if>>OR</option>
                    </select>
            ...
            <div class="btn-group">
                ...
                <a href="${pageContext.request.contextPath}/reader/advanced-search"
                   class="btn btn-reset">
                    Reset
                </a>
    ...
    <div class="book-grid">
        ...
        <c:forEach items="${books}" var="b">
            ...
            <div class="book-card">
                ...
                <a class="btn-detail"
                   href="${pageContext.request.contextPath}/reader/book-detail?id=${b.bookId}">
                    View Detail
                </a>
    ...
    <div class="pagination">
        ...
        <c:if test="${currentPage > 1}">
            <a href="${pageContext.request.contextPath}/reader/advanced-search?page=${currentPage-1}${query}">
                Previous
            </a>
        </c:if>
        ...
        <c:forEach begin="1" end="${totalPages}" var="i">
            ...
            <a class="${i==currentPage?'active':''}"
               href="${pageContext.request.contextPath}/reader/advanced-search?page=${i}${query}">
                ${i}
            </a>
