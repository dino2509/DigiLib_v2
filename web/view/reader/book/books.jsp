...
<div class="books-container">
    ...
    <div class="home-search">
        ...
        <form action="${pageContext.request.contextPath}/reader/search" method="get">
    ...
    <div class="book-list">
        ...
        <c:forEach items="${books}" var="b">
            ...
            <div class="book-card">
                ...
                <a href="${pageContext.request.contextPath}/reader/book-detail?id=${b.bookId}"
                   class="btn-detail">
                    Xem chi tiết
                </a>
    ...
    <div class="pagination">
        ...
        <c:if test="${currentPage > 1}">
            <a href="books?page=${currentPage-1}&keyword=${keyword}">Previous</a>
        </c:if>

        <c:forEach begin="1" end="${totalPages}" var="i">
            <a class="${i==currentPage?'active':''}"
               href="books?page=${i}&keyword=${keyword}">
                ${i}
            </a>
        </c:forEach>

        <c:if test="${currentPage < totalPages}">
            <a href="books?page=${currentPage+1}&keyword=${keyword}">Next</a>
        </c:if>
