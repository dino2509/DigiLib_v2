...
<div class="pagination">
    ...
    <c:if test="${currentPage > 1}">
        <a href="${pageContext.request.contextPath}/reader/search?page=${currentPage-1}&keyword=${keyword}&type=${type}">
            Previous
        </a>
    </c:if>
    ...
    <c:forEach begin="1" end="${totalPages}" var="i">
        <a class="${i==currentPage?'active':''}"
           href="${pageContext.request.contextPath}/reader/search?page=${i}&keyword=${keyword}&type=${type}">
            ${i}
        </a>
    </c:forEach>
